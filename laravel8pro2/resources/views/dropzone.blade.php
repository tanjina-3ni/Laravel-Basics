            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data" class="dropzone dz-clickable" id="image-upload" action="{{route('dropzoneStore')}}">
                                @csrf
                                <div>
                                    <h3 class="text-center">Upload Image By Click in the Box</h3>
                                </div>
